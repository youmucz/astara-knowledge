...
func TestResolveImageOCRHit_ChatEnrichmentDoesNotDuplicateOCR(t *testing.T) {
	...
	repo := &expandChunkRepo{
		chunks: map[string]*types.Chunk{
			"text": {
				ID: "text", KnowledgeID: "doc", ParentChunkID: "parent", ChunkType: types.ChunkTypeText, ChunkIndex: 3,
				Content: "![scan_page_1.jpg](images/scan_page_1.jpg)",
			},
			"parent": {
				ID: "parent", KnowledgeID: "doc", ChunkType: types.ChunkTypeParentText,
		...
		children: map[string][]*types.Chunk{
			"text": {{
				ID: "ocr-1", KnowledgeID: "doc", ParentChunkID: "text", ChunkType: types.ChunkTypeImageOCR,
