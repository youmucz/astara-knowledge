...
import type { KnowledgeEmbeddedSourceRef } from "@/embedded/contract";
...
type KnowledgeCard = {
  ...
  stall_state?: string;
  // Native Plane Pages synced through the Astara document seam carry
  // channel='astara'; keep this in sync with DocumentCardView's KnowledgeCard.
  channel?: string;
};
 ...
 */
const planePageSourceRef = (item: KnowledgeCard): KnowledgeEmbeddedSourceRef | null => {
